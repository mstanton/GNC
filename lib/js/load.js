$(function () {
  ...
  $('#btnRed').click(function(){
    ...
    var context = canvas.getContext("2d");
    //context.clearRect(0,0, canvas.width,canvas.height)
    context.fillStyle = "rgba(206,34,42, 0.4)"
    context.fillRect(0,0,canvas.width,canvas.height);
  });
  ...
  $('#btnPurple').click(function(){
    ...
    var context = canvas.getContext("2d");
    //context.clearRect(0,0, canvas.width,canvas.height)
    context.fillStyle = "rgba(148,44,202, 0.4)"
    context.fillRect(0,0,canvas.width,canvas.height);
  });
  ...
  $('#btnBlue').click(function(){
    ...
    var context = canvas.getContext("2d");
    //context.clearRect(0,0, canvas.width,canvas.height)
    context.fillStyle = "rgba(42,168,227, 0.4)"
    context.fillRect(0,0,canvas.width,canvas.height);
  });
  ...
  $('#btnGreen').click(function(){
    ...
    var context = canvas.getContext("2d");
    //context.clearRect(0,0, canvas.width,canvas.height)
    context.fillStyle = "rgba(59,159,84, 0.4)"
    context.fillRect(0,0,canvas.width,canvas.height);
  });
  ...
  $('#btnYellow').click(function(){
    ...
    var context = canvas.getContext("2d");
    //context.clearRect(0,0, canvas.width,canvas.height)
    context.fillStyle = "rgba(255,216,0, 0.4)"
    context.fillRect(0,0,canvas.width,canvas.height);
  });
