$(function () {
  ...
  input.addEventListener("change", function (evt) {
    ...
    if (formdata) {
      $.ajax({
        url: "http://localhost:8888/GNC/lib/php/upload.php",
        type: "POST",
        data: formdata,
        processData: false,
        contentType: false,
  ...
  $('#btnEnterTxt').click(function(){
    ...
    txtOverlay.src = 'http://localhost:8888/GNC/assets/images/txt_overlay.png';
 ...
 $('#btnAddText').click(function(){
    ...
    function returnImage(response) {
        $('#finalImage').attr('src', 'http://localhost:8888/GNC/assets/final/' + response);
        $('#previewShare').attr('src', 'http://localhost:8888/GNC/assets/final/' + response);    
    }
