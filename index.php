...
<div id="step2" class="crop container">
    <!-- Crop and save image -->
    <div class="box">
        <h3>STEP 2</h3>
...
<div id="step3" class="filter container">
    ...
    <div class="box">
        ...
        <div class="color_tools_container">
            <ul id="colorTools">
                <li><img src="rad_orange_on" width="32" height="32" alt="ORANGE"/></li>
                <li><img src="rad_red_off.png" width="32" height="32" alt="RED"/></li>
                <li><img src="rad_purple_off.png" width="32" height="32" alt="PURPLE"/></li>
                <li><img src="rad_blue_off.png" width="32" height="32" alt="BLUE"/></li>
                <li><img src="rad_green_off.png" width="32" height="32" alt="GREEN"/></li>
                <li><img src="rad_yellow_off.png" width="32" height="32" alt="YELLOW"/></li>
            </ul>
        </div>
        <button class="previous"></button>
        <button class="next"></button>
